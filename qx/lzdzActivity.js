...
var hostMap = {
    ...
    // https://lzkj-isv.isvjcloud.com/sign/wx/getActivity
    // https://cjhy-isv.isvjcloud.com/sign/wx/getShopInfo
    "lzdz-isv.isvjcloud.com": {
        appKey: "jd",
        name: "京东"
    }
}
...
function getApp() {
    ...
    if(match) {
        ...
        console.log(`[activity] match appKey=${appKey}, host=${host}`);
        return hostMap[host];
    }else {
        console.log(`[activity] no match appKey~`);
        return null;
    }
...
function update(body) {
    text = `${body}`;
    let opt = {
        url: `http://1.12.237.202:3000/uploadUrl`,
        body: `text=${text}`,
        headers: {
